...
This is a NEW module alongside the existing `AuditLogger` (which stays untouched for v0.2 compatibility). The `AuditLogger` callers migrate to ObservationStream in H-CP-7 when the launch orchestrator wires everything together.
