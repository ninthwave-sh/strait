...
**Test plan:**
- Run a manual end-to-end flow: launch a supported agent or fixture through the primary `strait` runtime, block a request, act from the desktop control plane, and verify the session unblocks
